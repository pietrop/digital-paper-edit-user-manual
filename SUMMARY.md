...
* [Paperediting](paperediting/README.md)
  ...
  * [2. Search](paperediting/2.-search/README.md)
    * [Search within one transcript](paperediting/2.-search/search.md)
    * [Search across transcripts in a project](paperediting/2.-search/search-across-transcripts-in-a-project.md)
  * [2. Select text from transcriptions](paperediting/2.-select-text-from-transcriptions/README.md)
    * [Move insert point](paperediting/2.-select-text-from-transcriptions/move-insert-point.md)
  ...
  * [9. Export](paperediting/9.-export/README.md)
    * [Export a video or audio preview](paperediting/9.-export/export-a-video-or-audio-preview.md)
